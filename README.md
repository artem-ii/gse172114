...
Quality control of raw data and other steps (with MultiQC) indicated reasonable data quality. The html reports can be found in corresponding folders depending on the tool.
...
Although the sample was too small to draw solid conclusions, I have analysed the variation of the loci and was able to identify several HLA alleles, that might be associated with the critical disease prognosis. DQA1\*01:05 was found in 13 critical versus 4 non-critical patients; DPA1\*02:01 - also in 13 vs 4; DQB1\*03:02 - in 8 vs 1 critical vs non-critical respectively.
Some published papers point mostly towards various alleles in the DRB1 locus as having predictive power over susceptibility or severity (*Augusto et al. 2023, Fakhkhari et al. 2023*). DRB1 cannot really be analysed in the current study because of high variability and small sample. However, at least in one study DQA1\*01 together with DRB1\*15 alleles were identified as having an increased frequencies in severe COVID19 cases that led to death, which is in line with my findings (*Hernández-Dno et al. 2022*).In addition to HLA-II typing, HLA-I typing may be interesting based on molecular function and existing publications on COVID19 and HLA typing.    
- Deconvolution analysis allowed to study the proportions of cells in peripheral blood of the patients. Congruent with the previous results, critical COVID-19 patients showed lymphopenia amidst strong evaluation of granulocyte levels. Interestingly, we found a higher granulocyte/lymphocyte ratio in the critical patients, complementary to recent research showing a correlation of neutrophil to lymphocyte ratio with the disease severity. Neutrophils may make up up to 70% of white blood cells, so granulocyte measure may be a good approximation.

To conclude, the patients with the critical form of COVID-19 display more intensive inflammatory processes in peripheral blood, which may be largely attributed to the activity of neutrophils, but also increased presence of monocytes and active inflammatory signaling. HLA-II haplotypes were investigated and several preliminary associations with disease severity, which corroborate previous publications were found. However, a larger sample is needed to draw any conclusions. Deeper analysis of WGCNA results may shed light on more details differentiating critical from non-critical COVID-19 patients.
